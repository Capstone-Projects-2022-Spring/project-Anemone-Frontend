...
import RainbowBrain from './image/anemone-03@1x.png';
import CollectIcon from './collectFeature';

export default function FeatureSpeedDial() {
    const actions = [
         { icon: <CollectIcon />, name: 'collectFeature'},
    ];
